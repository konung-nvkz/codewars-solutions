...
passed to your function,  albeit with the 'geese' removed. 
Note that all of the strings will be in the same case as those provided, 
and some elements may be repeated.
*/
//first more suitable version where geese us given as one more argument
function geese(geese, arr) {
    return arr.filter((element) => !geese.includes(element));
}

//and then the solution for the task
