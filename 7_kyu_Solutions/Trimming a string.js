...
function trim(str, num) {
    ...
    if (num<=3)return str.slice(0,num)+'...';// the line I have stuck at. see below
  ...
  // e.g. trim("He", 1) should return "H...", because 1 <= 3
  // so in the second 'if' we should compare not the str.length, but number of characters with 3!
