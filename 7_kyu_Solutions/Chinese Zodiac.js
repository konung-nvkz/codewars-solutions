...
function chineseZodiac(year) {
    ...
    let animal = animals[(year - 1924) % 12];
    let element = elements[(Math.floor((year - 1924) / 2)) % 5];
    return `${element} ${animal}`;
}

console.log(chineseZodiac(1925));//Wood Ox
console.log(chineseZodiac(1930));//Metal Horse
console.log(chineseZodiac(1956));//Fire Monkey
console.log(chineseZodiac(2012)); //Water Dragon
console.log(chineseZodiac(2024)); //Wood Fragon
