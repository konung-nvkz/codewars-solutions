...
console.log(calculate(2,"+", 4));//6, ok
console.log(calculate(6,"-", 1.5));//4,5, ok
console.log(calculate(-4,"*", 8));//-32, ok
console.log(calculate(49,"/", -7));//-7, ok
console.log(calculate(8,"m", 2));//null, ok
console.log(calculate(49,"/", 0));//null, ok
