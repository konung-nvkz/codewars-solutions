...
let str = "тен йорабок";// царь царевич, король, королевич, сапожник, портной";
console.log(reverseWords(str));

//,онжоротсо в етенретни теялуг .сурив нО теавичаровереп аволс в хакмар огондо .аволс У ,янем ,ястежак еокат с .монофелет
//,тяровог тизалыв ирп иинелвонбо аморх
