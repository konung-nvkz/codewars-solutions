...
function filterWords(phrase){
    return phrase.replace(/\b(bad|mean|ugly|horrible|hideous)\b/gi,'awesome');
}

//I added /b to ensure that the pattern matches the whole word and not just a substring.
//then, I added g and i to make a search global and case-insensitive.